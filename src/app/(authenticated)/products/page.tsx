...
import { findProduct, findStrain, listBrands, listProducts, listStrains, } from '@/lib/data/sales-settings';
...
export default async function ProductsPage({ searchParams }: {
    ...
    return (
        <div>
            <PageHeader
                title='Products'
                description='Build our final product catalog by connecting the strains we grow to the brands we sell.'
                actions={
            ...
            {showCreateProductDialog ?
                <ProductDialog mode='create' brands={serializedBrands} strains={serializedStrains} closeHref={productsHref} /> : null}
            {showEditProductDialog && serializedProduct ?
                <ProductDialog mode='edit' product={serializedProduct} brands={serializedBrands} strains={serializedStrains} closeHref={productsHref} /> : null}
        </div>
    );
}
