    ...
    <span className={cn("group relative isolate inline-flex size-4.5 items-center justify-center sm:size-4", className)}>
      ...
      <span
        ...
        className={cn(
          ...
          "group-hover:border-zinc-950/30 peer-checked:border-transparent peer-checked:bg-zinc-900 peer-checked:[&_svg]:opacity-100 peer-focus-visible:outline-2 peer-focus-visible:outline-offset-2 peer-focus-visible:outline-blue-500 peer-disabled:opacity-50",
