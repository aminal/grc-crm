...
export function DropdownItem({
    ...
    const classes = cn(
        className,
        'group cursor-pointer rounded-lg px-3.5 py-3 focus:outline-hidden sm:px-3 sm:py-2',
...
export function DropdownLabel({ className, ...props }: React.ComponentPropsWithoutRef<'div'>) {
    return <div {...props} data-slot='label' className={cn('col-start-2 row-start-1 font-medium text-md', className)} />;
}
