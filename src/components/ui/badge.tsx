...
const colors = {
  ...
  blue: "bg-purple-500/15 text-purple-700 group-data-hover:bg-purple-500/25 dark:text-purple-400 dark:group-data-hover:bg-purple-500/25",
...
export function StatusBadge({ status, prefix }: { status: OrderStatus | "available" | "sold" | "inactive" | "partial" | "unpaid" | "void"; prefix?: string }): React.ReactElement {
  const statusColors = {
    ...
    unpaid: "amber",
    void: "zinc",
  } satisfies Record<typeof status, BadgeColor>;
