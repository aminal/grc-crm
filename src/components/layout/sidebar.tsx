  ...
  const content = (
    <TouchTarget>
      ...
      <span className='min-w-0'>
        <span className='block truncate text-lg/5 font-semibold text-zinc-950 dark:text-white uppercase'>
          Green Room
        </span>
        <span className='block truncate text-sm/5 font-semibold text-zinc-500 dark:text-zinc-400'>
          CRM
        </span>
      </span>
    </TouchTarget>
